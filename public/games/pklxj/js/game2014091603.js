...
var Panel = function () {
	...
	RankUI = function () {
		...
		e.getFriendRank = function (t) {
		    this.title.innerHTML = "好友Leaderboard";
		    ...
		    !i || i && e - i.time > 60 ? ServerManager.getInstance().getFriendRank(lib.bind(function (i) {
		        100 == i.stat ? (this.con.innerHTML = "", this.addTextSpan("拉取排行数据出错，请稍后Retry", 1)) : (i.time = e, LocalStorage.set(n, i), this.fillFriendData(t, i))
		    },
					this),
				function () {
				    this.con.innerHTML = "",
					this.addTextSpan("拉取排行数据出错，请稍后Retry", 1)
		...
		e.fillFriendData = function (t, e) {
		    ...
		    if (i = lib.array.sort(i, ["score"], [1]), this.con.innerHTML = "", 0 == n.length) this.addTextSpan("好友暂无Score，快去抢占冠军吧", 1);
		    else {
		...
		e.fillWroldData = function (t) {
		    var e = UserManager.getInstance(),
				n = t.top20;
		    if (this.con.innerHTML = "", this.rankCount = Math.floor(t.rank) || 21, 0 === n.length) this.addTextSpan("暂无Score，快去抢占冠军吧", 1);
		    else {
		        var i,
					s,
					o = !1;
		...
		e.getWorldRank = function () {
		    this.title.innerHTML = "世界Leaderboard";
	...
	Floor100 = function () {
	    var t = BaseUI.extend({
	        ...
	        render: function () {
				...
				}).inject(t).set("html", "Continue Game");
	    ...
	    e.prototype = {
	        initialize: function () {
	            ...
	            this.defaultShareInfo = {
	                ...
	                desc: "我和千颂伊玩跑酷！停Yes肯定停不下来的，除了你那个不行！",
	...
	$CacheData = {
	    base_share: [{
	        id: "999998",
	        level: "40",
	        dec: "跑了$层，Share给小伙伴们Challenge一下吧？"
	    }, {
	        id: "109",
	        level: "999999",
	        dec: "跑了$层，Share给小伙伴们Challenge一下吧？"

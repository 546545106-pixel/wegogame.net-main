...
var GameLayer = cc.Layer.extend({
	...
	shareButtonClick: function()
	{
		...
		if(MODE==kMode20){
			if(this.isGameWin){
				window.wxData.title = "我的随意门Score"+b+"秒，左拥凤姐右抱芙蓉，小样你行么？";
				window.wxData.desc = "我的随意门Score"+b+"秒，左拥凤姐右抱芙蓉，小样你行么？";
				window.wxFriend.title = "我的随意门Score"+b+"秒，左拥凤姐右抱芙蓉，小样你行么？";
			}else{
			...
			window.wxData.title = "我在倒计时模式中Score"+this.score+"，左拥凤姐右抱芙蓉，小样你行么？";
			window.wxData.desc = "我在倒计时模式中Score"+this.score+"，左拥凤姐右抱芙蓉，小样你行么？";
			window.wxFriend.title = "我在倒计时模式中Score"+this.score+"，左拥凤姐右抱芙蓉，小样你行么？";
		}
	},
});

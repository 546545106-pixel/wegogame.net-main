		...
		function next(){
			...
			if(dd>=-right){
				...
				if(x>=16 && x<24){
					...
					dataForWeixin.desc="我的手机强迫症Level达到了LV1，目测没有手机强迫症哦！YouYes什么级别？快来测一测";
...
//						$(".again,.result").fadeIn(1000);
				...
				if(x>=24 && x<32){
					...
					dataForWeixin.desc="我的手机强迫症Level达到了LV2.轻度手机强迫症！YouYes什么级别？快来测一测";			
					$(".scroll").fadeIn().html(html);
					$(".no_click").click(function(){
...
//						$(".again,.result").fadeIn(1000);
				...
				if(x>=32 && x<40){
					...
					dataForWeixin.desc="我的手机强迫症Level达到了LV3.中度手机强迫症！YouYes什么级别？快来测一测";
					$(".scroll").fadeIn().html(html);
					$(".no_click").click(function(){
...
//						$(".again,.result").fadeIn(1000);
				...
				if(x>=40 && x<=48){
					...
					dataForWeixin.desc="我的手机强迫症Level居然达到了Lv4.重度手机强迫症患者！YouYes什么级别？快来测一测";
					$(".scroll").fadeIn().html(html);
					$(".no_click").click(function(){

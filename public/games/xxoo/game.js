  ...
  function render() {
    ...
    switch (status) {
      case 'waiting':
        ...
        context.fillText('Time：' + maxTime.toFixed(2) + ' 秒', canvas.width, 70);
        break;
      case 'playing':
        context.save();
        context.textAlign = 'right';
        ...
        context.fillText('Time：' + (lifetime / 1000).toFixed(2) + ' 秒', canvas.width, 70);
        break;
      case 'gameover':
        context.save();
        ...
        context.fillText('更多Game', center[0], canvas.height / 2 + 400);
        context.beginPath();
        context.lineWidth = 3;

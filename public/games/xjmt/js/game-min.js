		...
		i.prototype.loadGroup = function(e, i, n) {
			...
			if (!this.itemListDic[i] && i)
				if (e && 0 != e.length) {
					...
					this.next()
				} else egret.Logger.warning('RESLoad了不存在或空的资源组："' + i + '"'), e = new t.ResourceEvent(t.ResourceEvent.GROUP_LOAD_ERROR), e.groupName = i, this.dispatchEvent(e)
		};
...
(function(t) {
	...
	t.setItem = function(t, e) {
		try {
			...
			return console.log("egret_html5_localStorage.setItemSaveDefeat,key=" + t + "&value=" + e), !1
		}
	};
	t.removeItem = function(t) {
...
var __extends = this.__extends || function(t, e) {
	...
	Main = function(t) {
		...
		e.prototype.onResourceLoadError = function(t) {
			console.warn("Group:" + t.groupName + " 中有LoadDefeat的项目");

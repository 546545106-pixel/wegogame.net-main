...
Main.shareTextMap = {
	"0": {
		tip: "没打中,手滑!再来一次~"
		,title: "玩到了一个坑爹的Game，不想砸手机就千万别来玩！"
	}
	,"1": {
		tip: "没吃饱饭吗,用力用力!!"
		,title: "我把笨熊打出了${m}米，击败了${n}%Person，来Challenge我吧！"
	}
	,"2": {
		tip: "死鬼!想把我打去北极吗!"
		,title: "我把笨熊打出了${m}米，击败了${n}%Person，来Challenge我吧！"
...
Main.on("gameOver", function(event, distance, x){
	Main.log("Game Over:" + Main.getTotalDistance(distance));
	...
	setTimeout(function(){
		...
		if(hasNewMaxScore && score > 700){
			btGame.playScoreMsg("企鹅大复仇，大力出奇迹！你获得了最好的成绩，快跟好友Share一下吧");
			btGame.setShare({

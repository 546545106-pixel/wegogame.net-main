...
function main() {
  ...
  var cnm = {};	
  cnm.isShowClue1 = true;//显示"Click加入主屏幕"标签
  ...
  var BTN_HOME = {//游戏结束
    ...
    function _game_show()  {
        ...
        { 
            movingTimer = -1; 			 
			//document.title = window.shareData.tTitle = "我在经典游戏【木乃伊】中玩了" + (level+1)+ "关" + //window.shareData.Rankstr + ",据说全世界只有不到10个人通过，一起来Challenge吧！";

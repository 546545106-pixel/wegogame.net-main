...
var helpCallback = function(sender){
    ...
    var helpLabel = cc.LabelTTF.create("Click屏幕下方左右键砍杀怪物", "Arial", 20);
...
var popupWindow = function(){
    ...
    var resultLabel = cc.LabelTTF.create("您坚持了" + Math.floor(duration * 100) / 100 + "秒，听说没人能过37秒，快让小伙伴们来Challenge吧！！！",

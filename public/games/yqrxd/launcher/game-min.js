        ...
        a.prototype.loadGroup = function(a, b, d) {
            ...
            if (!this.itemListDic[b] && b)
                if (a && 0 != a.length) {
                    ...
                    this.next()
                } else egret.Logger.warning('RESLoad了不存在或空的资源组："' + b + '"'), a = new c.ResourceEvent(c.ResourceEvent.GROUP_COMPLETE), a.groupName = b, this.dispatchEvent(a)
        };
...
(function(c) {
    ...
    c.setItem = function(c, b) {
        try {
            ...
            return console.log("egret_html5_localStorage.setItemSaveDefeat,key=" + c + "&value=" + b), !1
        }
    };
...
var __extends = this.__extends || function(c, d) {
    ...
    GameOverPanel = function(c) {
        ...
        d.prototype.doAbout = function(b) {
            b.target.text = "All Rights Reserved:聆听Q语"
        };
        ...
        d.prototype.te = function(b) {
            for (var a = 0; a < this.btnArr.length; a++)
                if (this.btnArr[a].scaleX = this.btnArr[a].scaleY =
                    ...
                    var c = b.target.name;
                    "pay" == c.slice(0, 3) && (this.getToolNum = c.slice(6), console.log(this.getToolNum), this.checkGoldValue(parseInt(this.getToolNum) - 1), this.canPay ? this.checkClickTool(parseInt(this.getToolNum)) : console.log("Coins不足"))
                }
        };
        d.prototype.checkGoldValue = function(b) {
            GameSystem.curGold >= GameSystem.payItemArr[b] ? (console.log("可以Buy"), this.canPay = !0) : this.canPay = !1
        };
        d.prototype.checkClickTool = function(b) {
            ...
            switch (b) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    console.log("Items5"), GameSystem.tenScore = !0
            }
        };
        d.prototype.loop = function(b) {};
        return d
...
var __extends = this.__extends || function(c, d) {
    ...
    InGame = function(c) {
        ...
        d.prototype.makeGameOver = function() {
            ...
            // ih5game.setShare({
            //     title: "有钱就任性2圣诞版",
            //     desc: "圣诞节任性了？，我得到" + this.gameSystemPanel.scoreNum + "分,不想没钱认命的快来Challenge!"
            // })
        };
        d.prototype.onTouchBegin = function(b) {
...
var __extends = this.__extends || function(c, d) {
    ...
    MainGame = function(c) {
        ...
        d.prototype.loadData = function() {
            ...
            // console.info("Coins = " + ih5game.storage.get(b));

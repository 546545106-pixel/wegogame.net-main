...
POP.splash = function() {
    ...
    POP.draw.text(110,240, POP.Ua.action + 'Start Game', 16, col);
    POP.draw.text(128, 340, 'High Score', 20, 'rgba(255,255,255,0.8)');
...
POP.gameOver = function() {
	...
	if(!POP.isEndGame){
		...
		//btGame.playScoreMsg("泡泡克星就YesYou！拿了"+POP.score.total+"分，不去炫耀一下吗？");

...
var StartLayer = cc.Layer.extend({
    ctor: function(context){
        ...
        var btnTxt = cc.createSprite('@Start戳', {
            xy: [220, 40],
            fontSize: 46,
            color: '#00a538'
        });
...
var HelloWorldLayer = cc.Layer.extend({
    ...
    gameOver: function(){
        ...
        layerMask.delay(0.5).then(function(){
            ...
            var text = cc.tmpl("强迫症真的伤不起，你干掉了{score}个新提示。Share给你的强迫症好友吧。", {tap: self.tap, score: score, percent: (percent * 100).toFixed(1)});

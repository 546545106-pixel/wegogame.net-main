        ...
        a.prototype.loadGroup = function(a, d, e) {
            ...
            if (!this.itemListDic[d] && d)
                if (a && 0 != a.length) {
                    ...
                    this.next()
                } else egret.Logger.warning('RESLoad了不存在或空的资源组："' + d + '"'), a = new b.ResourceEvent(b.ResourceEvent.GROUP_COMPLETE), a.groupName = d, this.dispatchEvent(a)
        };
...
var __extends = this.__extends || function(b, e) {
    ...
    Main = function(b) {
        ...
        e.prototype.doShare = function() {
            ...
            ih5game.setShare({
                title: "这个圣诞要脱光！",
                desc: "圣诞快乐！IHelp圣诞老人裸奔了" + b.timeCount / 10 + "秒！打败了全国" + b.percent + "%的脱光狂人！"
            });
        };

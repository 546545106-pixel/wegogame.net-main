...
function qike_h5_v1_progress() {
	...
	if (qike_h5_v1_time >= qike_h5_v1_totaltime) {
		...
		document.getElementById("J-qike-h5-v1-progress").innerHTML = '...Game <span style="color:#f00">' + _5 + '</span> 秒后开始...';
...
var qike_h5_v1_ad = {
	"content": "<script src=\"/game-ad-api.js\"><\/script><script>window.GameAdAPI && GameAdAPI.requestGameAd('shengdanpengpengle_interstitial');<\/script>"
};

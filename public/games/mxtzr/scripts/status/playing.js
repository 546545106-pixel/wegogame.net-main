...
void function (window, undefiend) { /* 缓存核心对象 */
 ...
 renderer.clear(); 
 // 准备开始绘制 
 renderer.begin(); renderer.context.shadowBlur = 10; renderer.context.shadowColor = "#000"; renderer.drawText("正在Loading...", (renderer.width - renderer.getTextWidth("正在Loading...", "Bold 36px 微软雅黑,黑体")) / 2, 550, "#fff", "Bold 36px 微软雅黑,黑体"); 
 // 结束绘制 

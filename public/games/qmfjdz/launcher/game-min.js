...
(function(c) {
    var e = function(e) {
        ...
        b.prototype._getLinesArr = function() {
            ...
            if (this._hasWidthSet && 0 == this._explicitWidth) return console.warn("文本宽度被Settings为0"), this._numLines = 0, [{
                width: 0,
                height: 0,
                elements: []
            }];
        ...
        b.prototype.loadGroup = function(a, d, b) {
            ...
            if (!this.itemListDic[d] && d)
                if (a && 0 != a.length) {
                    ...
                    this.next()
                } else egret.Logger.warning('RESLoad了不存在或空的资源组："' + d + '"'), a = new c.ResourceEvent(c.ResourceEvent.GROUP_LOAD_ERROR), a.groupName = d, this.dispatchEvent(a)
        };
    ...
    (function(e) {
        var f = function(b) {
            ...
            a.prototype.onAddToStage = function(a) {
                if (e.UIGlobals._uiStage) throw Error("UIStageYesGUI根容器，只能有一个此实例在显示列表中！");
...
(function(c) {
    ...
    c.setItem = function(c, f) {
        try {
            ...
            return console.log("egret_html5_localStorage.setItemSaveDefeat,key=" + c + "&value=" + f), !1
        }
    };
    c.removeItem = function(c) {
...
var __extends = this.__extends || function(c, e) {
        ...
        e.prototype.setProgress = function(c, b) {
            this.textField.text = "资源Loading..." + c + "/" + b
        };
        return e
    }(egret.Sprite);

    ...
    if (uc_param_str.fr === 'android' || uc_param_str.fr === 'iphone') {
        if (uc_param_str.fr === 'android') {
            ...
            if (this.isVersionOver("9.9.0.0")) {
                ...
                ucbrowser.web_share(this.gamelebi.shareData.title, this.gamelebi.shareData.content, this.gamelebi.shareData.link, '', '', '来自乐比Game', 'gamelebiucicon')
            } else {
                location.href = "ext:web_share:"
            }
        }
    } else {
        this.gamelebi.utils.debug("其它Share接口")
    }
};
